...
export const TradeWindow: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Caps in design px, not viewport units — the whole UI is scaled, so a
          vw/vh cap would stop binding as soon as the player shrinks. */}
      <WindowContainer className="w-[560px] max-w-[1800px] max-h-[860px] overflow-y-auto" style={{ paddingRight: "8px" }}>
        {/* Header */}
